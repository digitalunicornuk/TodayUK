...
<?php if(have_posts()): ?><div class="section-story-grid"><?php  $story_count=0; while(have_posts()):the_post();todayuk_card();$story_count++;if($story_count===6){echo '<div class="section-ad-row">';todayuk_ad("article_middle");echo '</div>';}endwhile; ?></div><?php if($story_count<6)todayuk_ad("article_bottom"); ?><div class="pagination"><?php the_posts_pagination(['prev_text'=>'← Newer','next_text'=>'Older →']); ?></div>

...
const config={mode:'off',tools:[],question:'',options:[],area:'',topic:'',org:'',event_date:''};await client.createDraft('10000000-0000-4000-8000-000000000001','Headline','Body',config);assert.deepEqual(JSON.parse(sent.opts.body).todayuk_engagement,config);await assert.rejects(client.verifyEngagement(42,config),/not confirmed/);
